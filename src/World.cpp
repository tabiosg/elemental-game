...
int main() {
	...
	std::cout << "Three enemies looking to start a fight showed up." << std::endl << std::endl;
	std::cout << "You ask " << name1 << ", " << name2 << ", and " << name3 << 
		" if they've heard of these enemies, but they have not! " << std::endl;
	...
	std::cout << std::endl << "Choose the name of the first enemy." << std::endl;
	std::cin >> name4;
	std::cout << std::endl << "Choose the name of the second enemy." << std::endl;
	std::cin >> name5;
	std::cout << std::endl << "Choose the name of the third enemy." << std::endl;
	std::cin >> name6;
	...
	std::cout << "Now it's time to fight! Let the brawl begin!" << std::endl << std::endl;
